...
<template>
    <div class="mainPage">
        ...
        <div v-for="(message, index) in messages" :key="index" :class="['message', message.from === messageStore.currentUser.username ? 'right' : 'left']">
            <div class="sender"><strong>{{ message.from }}</strong></div>
